    ...
    <div className="pl-landing" style={{ background: 'var(--bg)', color: 'var(--ink)', fontFamily: 'var(--f-sans)' }}>
        ...
        <div style={{ maxWidth: 'var(--max)', margin: '0 auto' }}>
          ...
          <FadeUp delay={0.08}>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(200px,1fr))', gap: 14 }}>
              ...
              {[
                { tag: 'sync', name: 'Apple Calendar', desc: 'Subscribe once on iPhone & Mac — your posting schedule shows up and auto-refreshes. Works with Outlook too.', svg: <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 24, height: 24 }}><path d="M16.365 1.43c0 1.14-.42 2.18-1.12 2.95-.78.85-2.05 1.5-3.1 1.42-.13-1.1.45-2.27 1.1-2.99.75-.82 2.06-1.43 3.12-1.38zM20.5 17.06c-.35.83-.52 1.2-.98 1.93-.66 1.03-1.59 2.32-2.74 2.33-1.02.01-1.28-.66-2.67-.66-1.39 0-1.68.65-2.7.67-1.14.04-2.01-1.11-2.67-2.14-1.85-2.86-2.05-6.22-.9-8 .8-1.27 2.08-2.01 3.28-2.01 1.22 0 1.98.67 2.99.67.98 0 1.57-.67 2.98-.67 1.06 0 2.19.58 3 1.57-2.63 1.44-2.2 5.2.31 6.31z"/></svg> },
      ...
      <section id="pricing" style={{ background: 'var(--bg)', borderTop: '1px solid var(--line)', padding: 'clamp(60px,8vw,100px) var(--pad)' }}>
        <div style={{ maxWidth: 'var(--max)', margin: '0 auto' }}>
          ...
          {/* Free-tier strip */}
          <FadeUp>
            <div className="pl-free-strip" style={{
              ...
              <div>
                <div style={{
                  ...
                  color: 'var(--ink-4)', marginBottom: 6, letterSpacing: '0.04em',
                }}>
                  // or — try it free
                </div>
                <h3 style={{
                ...
                <p style={{
                  ...
                  {TIER_LIMITS.free.postsPerMonth} posts a month. 1 voice fingerprint. Posts ship with a small watermark. No card.
                </p>
              </div>
              <button
                ...
                style={{
                  ...
                  height: 48, padding: '0 22px', borderRadius: 'var(--r-md)',
