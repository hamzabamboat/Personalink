...
// AI photo tile — a real gpt-image render (generated from the brief below)
function PhotoMock() {
  return (
    <div style={{ aspectRatio: '1 / 1', borderRadius: 'var(--r-md)', overflow: 'hidden', position: 'relative', border: '1px solid var(--line)', boxShadow: 'var(--sh-1)' }}>
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src="/landing/ai-photo.jpg" alt="A photoreal workspace image generated by PersonaLink from a text prompt" loading="lazy" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
      <span style={{
        position: 'absolute', left: 12, bottom: 12, fontFamily: 'var(--f-mono)', fontSize: 9.5,
        color: '#fff', background: 'rgba(0,0,0,0.42)', borderRadius: 'var(--r-pill)', padding: '3px 8px',
