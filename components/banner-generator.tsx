        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-2">
            <a href={url} download target="_blank" rel="noreferrer" className="flex-1">
              <Button variant="outline" className="w-full gap-1.5"><Download className="w-4 h-4" /> Download</Button>
            </a>
          ...
          <div className="text-[11px] text-slate-400">1584×396 — LinkedIn's banner size. Download it and set it as your profile background.</div>
        </div>
      ) : (
